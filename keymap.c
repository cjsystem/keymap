 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | ESC    |   1  |   2  |   3  |   4  |   5  |   6  |           |   7  |   8  |   9  |   0  |   -  |  =   |  ENT   |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | TAB    |   Q  |   W  |   E  |   R  |   T  |  F3  |           |  DEL |   Y  |   U  |   I  |   O  |    P | \/ALT  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | BkSp   | A/ALT|   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2|' / Cmd |
 * |--------+------+------+------+------+------|  F4  |           |  F2/ |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |  Cmd |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LGui  |//Ctr |ALT   |  UP  | DOWN |                                | LEFT | RIGHT|   [  |   ]  | L1   |
 *   `----------------------------------'                                `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | F5   | F6   |       | F7   |F8/Ctr|
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LGUI,       CTL_T(KC_SLSH),      KC_LALT,  KC_LEFT, KC_RIGHT,
                                                KC_F5,  KC_F6,
                                                              KC_F10,
                                               KC_SPC,KC_BSPC,KC_F12,
        // right hand
